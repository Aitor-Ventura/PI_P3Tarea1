...
/**
 * Ejercicio 1: Realizar las modificaciones que estime oportunas al código del Turnomatic para darle una nueva funcionalidad como piano. En esta modalidad de funcionamiento cada tecla del telcado del 4x3 tendrá una nota musical anotada.
 * Para entrar en modo piano, se ha de pulsar la secuencia de teclas *#. Para salir del modo piano, se pulsarán los pulsadores UP and DOWN simultáneamente, retornando así a la funcionalidad del Turnomatic.
 */
void piano() {
  teclado(estado);
  switch(tecla_actual) {
...
// si teclau != 15 es que se ha pulsado una tecla
    ...
    if((tecla_anterior == '*') && (tecla_actual ==  0x23)) {
      modoTurnomatic == 0;
      piano();
    }
